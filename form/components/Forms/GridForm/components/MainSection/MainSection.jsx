...
export default class MainSection extends Component {
    ...
    render() {
        ...
        return (
            <div className="md:col-span-2 grid self-start">
                <div className="justify-self-end my-3 flex items-center gap-3">
                    <div
                        onClick={this.handleResetTable}
                        title="Reset table"
                        className=" cursor-pointer bg-grey-light hover:bg-grey text-grey-darkest font-semibold py-2 px-2 rounded inline-flex items-center hover:text-red-400"
                    >
                        <ResetIcon />
