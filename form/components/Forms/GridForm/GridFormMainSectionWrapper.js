...
export default function GridFormMainSectionWrapper({
    ...
    return (
        <div className="p-2 m-0 lg:p-8 md:p-8 lg:mt-4 md:mt-4">
            <div className="flex items-center max-w-screen-2xl m-auto mb-2 justify-between">
            ...
            <div className="flex flex-col justify-center items-center max-w-screen-2xl m-auto border bg-white">
