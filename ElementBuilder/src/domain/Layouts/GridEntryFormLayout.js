...
export default class GridEntryFormLayout extends Layout {
    /**
     *
     * @param {string} name
    ...
    render() {
        ...
        <div class="row w-100 p-0 flex-row-between-center m-0 layout-container">
            ...
            <a 
              ...
              class="flex-row-center-center p-2 section" 
              href="${this.sections[2].redirectURL}&section=${this.sections[2].name}">
                <span>${this.sections[2].alias}</span>
            </a>
        </div>
        `;
    }
